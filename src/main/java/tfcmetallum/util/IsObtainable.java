...
public static boolean tough_alloy;
	...
	public static void checkObtanability() {
		...
		if (ConfigTFCM.METALS.ardite && ConfigTFCM.METALS.cobalt && ConfigTFCM.METALS.manyullyn) {
			manyullyn = true;
		}
		...
		if (ConfigTFCM.METALS.tungsten && ConfigTFCM.METALS.tungsten_steel) {
			tungsten_steel = true;
		}
		...
		if (ConfigTFCM.METALS.aluminium && ConfigTFCM.METALS.beryllim && ConfigTFCM.METALS.beryllim_copper) {
