...
public final class ArmorMaterialsTFCM
{
    ...
    public static final IArmorMaterialTFC BORON = new ArmorMaterialTFC(EnumHelper.addArmorMaterial("tfcm_boron", TerraFirmaCraft.MOD_ID + ":boron", 120, new int[] {3, 6, 8, 3}, 17, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 4.0F), 25, 50, 25);
    public static final IArmorMaterialTFC THORIUM = new ArmorMaterialTFC(EnumHelper.addArmorMaterial("tfcm_thorium", TerraFirmaCraft.MOD_ID + ":thorium", 120, new int[] {2, 6, 7, 3}, 17, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 8.0F), 50, 25, 25);
